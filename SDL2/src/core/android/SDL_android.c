...
static jobject mLayoutInstance;
static jclass mLayoutClass;
...
JNIEXPORT void JNICALL SDL_Android_Init(JNIEnv* mEnv, jobject obj)
{
    ...
    jobject context = (*mEnv)->CallObjectMethod(mEnv, mLayoutInstance, midGetContext);
    mContext = (jobject)((*mEnv)->NewGlobalRef(mEnv, context));

    midGetNativeSurface = (*mEnv)->GetMethodID(mEnv, mLayoutClass,
...
// ------------------------------------------------------------------------------------------------
// Stubs of removed C Audio functions:

int Android_JNI_OpenAudioDevice(int iscapture, int sampleRate, int is16Bit, int channelCount, int desiredBufferFrames) { return 0; };
void* Android_JNI_GetAudioBuffer(void) { return NULL; };
void Android_JNI_WriteAudioBuffer(void) {};
int Android_JNI_CaptureAudioBuffer(void *buffer, int buflen) { return 0; };
...
ANativeWindow* Android_JNI_GetNativeWindow(void)
{
    ...
    s = (*env)->CallObjectMethod(env, mLayoutInstance, midGetNativeSurface);
...
void Android_JNI_SetActivityTitle(const char *title)
{
    ...
    mid = (*mEnv)->GetMethodID(mEnv, mLayoutClass,"setActivityTitle","(Ljava/lang/String;)Z");
    if (mid) {
        jstring jtitle = (jstring)((*mEnv)->NewStringUTF(mEnv, title));
        (*mEnv)->CallBooleanMethod(mEnv, mLayoutInstance, mid, jtitle);
...
static int Internal_Android_JNI_FileOpen(SDL_RWops* ctx)
{
    ...
    mid = (*mEnv)->GetMethodID(mEnv, (*mEnv)->GetObjectClass(mEnv, mContext),
            "getAssets", "()Landroid/content/res/AssetManager;");
    assetManager = (*mEnv)->CallObjectMethod(mEnv, mContext, mid);
...
fallback:
        ...
        if (Android_JNI_ExceptionOccurred(SDL_FALSE)) {
            ...
            mid = (*mEnv)->GetMethodID(mEnv, mLayoutClass,
            ...
            inputStream = (*mEnv)->CallObjectMethod(mEnv, mLayoutInstance, mid, fileNameJString);
...
static jobject Android_JNI_GetSystemServiceObject(const char* name)
{
    ...
    mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, mContext), "getSystemServiceFromUiThread", "(Ljava/lang/String;)Ljava/lang/Object;");
    manager = (*env)->CallObjectMethod(env, mContext, mid, service);
...
int Android_JNI_GetPowerInfo(int* plugged, int* charged, int* battery, int* seconds, int* percent)
{
    ...
    mid = (*env)->GetMethodID(env, mLayoutClass, "registerReceiver", "(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;");
    intent = (*env)->CallObjectMethod(env, mLayoutInstance, mid, NULL, filter);
...
int Android_JNI_GetTouchDeviceIds(int **ids) {
    ...
    jmethodID mid = (*env)->GetMethodID(env, mLayoutClass, "inputGetInputDeviceIds", "(I)[I");
    jintArray array = (jintArray) (*env)->CallObjectMethod(env, mLayoutInstance, mid, sources);
    int number = 0;
    *ids = NULL;
    if (array) {
...
int Android_JNI_SendMessage(int command, int param)
{
    ...
    mid = (*env)->GetMethodID(env, mLayoutClass, "sendMessage", "(II)Z");
    if (!mid) {
        return -1;
    }
    success = (*env)->CallBooleanMethod(env, mLayoutInstance, mid, command, param);
    return success ? 0 : -1;
}
...
const char * SDL_AndroidGetInternalStoragePath()
{
    ...
    if (!s_AndroidInternalFilesPath) {
        ...
        mid = (*env)->GetMethodID(env, (*env)->GetObjectClass(env, mContext),
                "getFilesDir", "()Ljava/io/File;");
        fileObject = (*env)->CallObjectMethod(env, mContext, mid);
        if (!fileObject) {
...
int SDL_AndroidGetExternalStorageState()
{
    ...
    stateString = (jstring)(*env)->CallObjectMethod(env, cls, mid);
...
const char * SDL_AndroidGetExternalStoragePath()
{
    ...
    if (!s_AndroidExternalFilesPath) {
        ...
        fileObject = (*env)->CallObjectMethod(env, mContext, mid, NULL);
        if (!fileObject) {
